...
------------------------------------------------------------------------
  ...
  the myTestTable table.  The agent will start by looking for the right
  ...
  file defaults/table-myTestTable.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      myTestTable_allocate_data
      myTestTable_release_data
 ...
 Index(es) for the myTestTable table
  ------------------------------------------------------------
  The index(es) for the myTestTable table are:
...
************************************************************************
myTestTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the myTestTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: myTestTable_data_access.[c|h]
------------------------------------------------------------------------
  The myTestTable_data_access file contains the interface to your data in
  ...
  FUNC : myTestTable_indexes_set
  WHERE: myTestTable_data_access.c
...
File: myTestTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : myROIntCol2_get



File: myTestTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the myTestTable table.

To watch the flow of the myTestTable table, use the
following debug tokens:
        ...
        myTestTable
        verbose:myTestTable
        internal:myTestTable

e.g.
        snmpd -f -Le -DmyTestTable,verbose:myTestTable,internal:myTestTable
...
/*---------------------------------------------------------------------
 * AGENTX-TUTORIAL-MIB::myTestTableEntry.myROStringCol1
 * myROStringCol1 is subid 1 of myTestTableEntry.
